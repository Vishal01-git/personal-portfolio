...
import { Network, Database, Cpu, Terminal, User, Mail, Search, Clock, ArrowRight, Hash, X } from 'lucide-react';
import { links } from '@/data/links';

const RECENT_KEY = 'cmd_palette_recent';
const MAX_RECENT = 4;

// ── Commands built from data — links come from data/links.ts ──────────────
const COMMANDS = [
  ...
  { id: 'resume',       label: 'Download Resume', sublabel: 'PDF · latest version',      href: links.resume,      icon: <ArrowRight className="w-4 h-4" />, category: 'Links' },
];
